...
Autocomplete: Autocomplete.hpp
	$(CXX) $(CXXFLAGS) -c Autocomplete.hpp MWT.hpp MWTNode.hpp

main2: main2.o DocumentGenerator AutocompleteUtils test2
...
test2: test2.o
	$(CXX) $(LDFLAGS) -o test2 test2.o DocumentGenerator.hpp CustomTree.hpp CustomNode.hpp

test2.o:	test2.cpp DocumentGenerator
	$(CXX) $(CXXFLAGS) -c test2.cpp 

clean:
	$(RM) main main2 test test2 *.o *.gch
